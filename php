                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="colete-details" style="display: none; align-items: center; gap: 15px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="lastro-details" style="display: none; align-items: center; gap: 15px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="neoprene-details" style="display: none; align-items: center; gap: 15px;">
                                                <span>Sabe o tamanho?</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="nadadeira-details" style="display: none; align-items: center; gap: 15px;">
                                                <span>Sabe o tamanho?</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="lanterna-details" style="display: none; align-items: center; gap: 15px;">
                                                <span>Sabe a quantidade?</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            ...
                                            <div class="computador-details" style="display: none; align-items: center; gap: 15px;">
                                                <span>Sabe a quantidade?</span>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function toggleEquipDetails(ownerCheckbox) {
            ...
            var isChecked = ownerCheckbox.is(':checked');
            targetGroup.css('display', isChecked ? 'inline-flex' : 'none');
            if (!isChecked) {
                targetGroup.find('.equip-detail-toggle').prop('checked', false).trigger('change');
            }
        }

        function toggleEquipInput(detailCheckbox) {
            var targetInput = $(detailCheckbox.data('target'));
            var isChecked = detailCheckbox.is(':checked');
            targetInput.toggle(isChecked);
            if (!isChecked) {
                targetInput.val('');
            }
        }
