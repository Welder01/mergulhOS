...
<style>
    ...
    .progress-bar {
        ...
        line-height: 25px;
        color: #333;
        /* Cor do texto escura para melhor legibilidade */
        font-weight: bold;
        text-align: center;
    ...
    <div class="span12">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding wizard-content">
                ...
                <?php if (isset($result->importacao_inconsistente) && $result->importacao_inconsistente == 1): ?>
                    <div class="alert alert-error"
                        style="background-color: #f2dede; color: #b94a48; border-color: #eed3d7;">
                        <i class="fas fa-exclamation-triangle"></i> <strong>Atenção:</strong> Este cadastro foi importado
                        com dados inconsistentes (Email e/ou Documento faltantes foram gerados automaticamente). Por favor,
                        atualize os dados.
                    </div>
                <?php endif; ?>
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal"
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a data-toggle="tab" href="#pessoal"><i class="bx bx-user"></i> Dados
                                Pessoais</a></li>
                        ...
                        <li><a data-toggle="tab" href="#saude"><i class="bx bx-first-aid"></i> Saúde e Segurança</a>
                        </li>
                        <li><a data-toggle="tab" href="#restricoes"><i class="bx bx-food-menu"></i> Restrições</a></li>
                        <li><a data-toggle="tab" href="#certificacoes"><i class="bx bx-certification"></i>
                                Certificações</a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="pessoal" class="tab-pane active">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="nomeCliente" type="text" name="nomeCliente"
                                        value="<?php echo $result->nomeCliente; ?>" class="monitor-input" />
                                    <input id="idClientes" type="hidden" name="idClientes"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="documento" type="text" name="documento"
                                        value="<?php echo $result->documento; ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="sexo" id="sexo">
                                        ...
                                        <option value="Masculino" <?php if ($result->sexo == 'Masculino')
                                            echo 'selected'; ?>>Masculino</option>
                                        <option value="Feminino" <?php if ($result->sexo == 'Feminino')
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="data_nascimento" class="datepicker monitor-input" type="text"
                                        name="data_nascimento"
                                        value="<?= $result->data_nascimento ? date('d/m/Y', strtotime($result->data_nascimento)) : ''; ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="altura" class="control-label">Altura (m)</label>
                                <div class="controls">
                                    <input id="altura" type="text" name="altura" value="<?= $result->altura ?? '' ?>"
                                        class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="peso" type="text" name="peso" value="<?= $result->peso ?? '' ?>"
                                        class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="switch">
                                        <input name="fornecedor" type="checkbox" value="1" <?php if ($result->fornecedor)
                                            echo 'checked'; ?>>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="contato" type="text" name="contato"
                                        value="<?php echo $result->contato; ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="telefone" type="text" name="telefone"
                                        value="<?php echo $result->telefone; ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="celular" type="text" name="celular"
                                        value="<?php echo $result->celular; ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="complemento" type="text" name="complemento"
                                        value="<?php echo $result->complemento; ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_colete" value="1" <?= ($result->possui_colete ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe o tamanho?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#tamanho_colete"
                                                    <?= !empty($result->tamanho_colete) ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="tamanho_colete" type="text" name="tamanho_colete"
                                                value="<?= $result->tamanho_colete ?? '' ?>" placeholder="Qual tamanho?"
                                                class="span1 monitor-input" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_lastro" value="1" <?= ($result->possui_lastro ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe o peso?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#peso_lastro"
                                                    <?= !empty($result->peso_lastro) ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="peso_lastro" type="text" name="peso_lastro"
                                                value="<?= $result->peso_lastro ?? '' ?>" placeholder="Qual peso (kg)?"
                                                class="span1 monitor-input" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_neoprene" value="1" <?= ($result->possui_neoprene ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe o tamanho?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#tamanho_neoprene"
                                                    <?= !empty($result->tamanho_neoprene) ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="tamanho_neoprene" type="text" name="tamanho_neoprene"
                                                value="<?= $result->tamanho_neoprene ?? '' ?>"
                                                placeholder="Qual tamanho?" class="span1 monitor-input" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_nadadeira" value="1" <?= ($result->possui_nadadeira ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe o tamanho?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#tamanho_nadadeira"
                                                    <?= !empty($result->tamanho_nadadeira) ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="tamanho_nadadeira" type="text" name="tamanho_nadadeira"
                                                value="<?= $result->tamanho_nadadeira ?? '' ?>"
                                                placeholder="Qual tamanho?" class="span1 monitor-input" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_regulador" value="1" <?= ($result->possui_regulador ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe a quantidade?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#qtd_reguladores"
                                                    <?= ($result->qtd_reguladores ?? 0) > 0 ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="qtd_reguladores" type="number" name="qtd_reguladores"
                                                value="<?= $result->qtd_reguladores ?? 0 ?>" placeholder="Quantos?"
                                                class="span1 monitor-input" min="0" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_lanterna" value="1" <?= ($result->possui_lanterna ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe a quantidade?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#qtd_lanterna"
                                                    <?= ($result->qtd_lanterna ?? 0) > 0 ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="qtd_lanterna" type="number" name="qtd_lanterna"
                                                value="<?= $result->qtd_lanterna ?? 0 ?>" placeholder="Quantas?"
                                                class="span1 monitor-input" min="0" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="equip-row">
                                            <span>Possui?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    name="possui_computador" value="1" <?= ($result->possui_computador ?? 0) ? 'checked' : '' ?>><span class="slider"></span></label>
                                            <span>Sabe a quantidade?</span>
                                            <label class="switch small-toggle"><input type="checkbox"
                                                    class="equip-detail-toggle" data-target="#qtd_computador"
                                                    <?= ($result->qtd_computador ?? 0) > 0 ? 'checked' : '' ?>><span
                                                    class="slider"></span></label>
                                            <input id="qtd_computador" type="number" name="qtd_computador"
                                                value="<?= $result->qtd_computador ?? 0 ?>" placeholder="Quantos?"
                                                class="span1 monitor-input" min="0" />
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div id="saude" class="tab-pane">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="contato_emergencia_nome" type="text" name="contato_emergencia_nome"
                                        value="<?= $result->contato_emergencia_nome ?? '' ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="contato_emergencia_telefone" class="control-label">Telefone</label>
                                <div class="controls">
                                    <input id="contato_emergencia_telefone" type="text"
                                        name="contato_emergencia_telefone"
                                        value="<?= $result->contato_emergencia_telefone ?? '' ?>"
                                        class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="contato_emergencia_parentesco" type="text"
                                        name="contato_emergencia_parentesco"
                                        value="<?= $result->contato_emergencia_parentesco ?? '' ?>"
                                        class="monitor-input" />
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="atestado_medico_emissao" type="text" name="atestado_medico_emissao"
                                        value="<?= $result->atestado_medico_emissao ? date('d/m/Y', strtotime($result->atestado_medico_emissao)) : '' ?>"
                                        class="monitor-input datepicker" />
                                    <span class="help-inline">A validade será calculada para 1 ano a partir desta
                                        data.</span>
                                </div>
                            </div>
                                    ...
                                    <div class="controls">
                                        <table class="table table-bordered" style="width: auto;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a href="<?= base_url('assets/uploads/atestados/' . $result->atestado_medico_arquivo) ?>"
                                                            target="_blank">
                                                            <i class="fas fa-file-alt"></i>
                                                            <?= substr($result->atestado_medico_arquivo, 13) ?>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="<?= site_url('clientes/remover_atestado/' . $result->idClientes) ?>"
                                                            class="btn btn-danger btn-mini"
                                                            onclick="return confirm('Deseja remover este atestado?')">Remover</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <input type="hidden" name="atestado_medico_arquivo_atual"
                                            value="<?= $result->atestado_medico_arquivo ?>">
                                    </div>
                                </div>
                            <?php endif; ?>
                            <div class="control-group">
                                <label for="atestado_medico_arquivo"
                                    class="control-label"><?= (isset($result->atestado_medico_arquivo) && $result->atestado_medico_arquivo) ? 'Substituir Atestado' : 'Arquivo do Atestado' ?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="nome_medico" type="text" name="nome_medico"
                                        value="<?= $result->nome_medico ?? '' ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="crm_medico" class="control-label">CRM do Médico</label>
                                <div class="controls">
                                    <input id="crm_medico" type="text" name="crm_medico"
                                        value="<?= $result->crm_medico ?? '' ?>" class="monitor-input" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="codigo_validacao_atestado" class="control-label">Código de Validação</label>
                                <div class="controls">
                                    <input id="codigo_validacao_atestado" type="text" name="codigo_validacao_atestado"
                                        value="<?= $result->codigo_validacao_atestado ?? '' ?>" class="monitor-input" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="restricoes" class="tab-pane">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="observacoes_restricao" type="text" name="observacoes_restricao"
                                        value="" />
                                </div>
                            </div>
                            <hr>
                                    ...
                                    <?php if (isset($restricoes) && !empty($restricoes)): ?>
                                        <?php foreach ($restricoes as $r): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= site_url('clientes/remover_restricao/' . $r->id) ?>"
                                                        class="btn btn-danger btn-mini"
                                                        onclick="return confirm('Deseja remover esta restrição?')">Remover</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                        ...
                        <div id="certificacoes" class="tab-pane">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="numero_certificacao" type="text" name="numero_certificacao"
                                        class="span12" value="" />
                                </div>
                            </div>
                            <div class="control-group">
                                    ...
                                    <?php if (isset($certificacoes) && !empty($certificacoes)): ?>
                                        <?php foreach ($certificacoes as $c): ?>
                                            <tr>
                                                ...
                                                <td><?= $c->data_emissao ? date('d/m/Y', strtotime($c->data_emissao)) : '-' ?>
                                                </td>
                                                <td>
                                                    <?php if ($c->arquivo): ?>
                                                        <a href="<?= base_url('uploads/certificados/' . $c->arquivo) ?>"
                                                            target="_blank" class="btn btn-mini"><i class="icon-download"></i></a>
                                                    <?php endif; ?>
                                                    <a href="<?= site_url('clientes/remover_certificacao/' . $c->id) ?>"
                                                        class="btn btn-danger btn-mini"
                                                        onclick="return confirm('Deseja remover esta certificação?')">Remover</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                            ...
                            <div class="span6 offset3" style="display:flex;justify-content: center">
                                <button type="submit" class="button btn btn-primary">
                                    <span class="button__icon"><i class="bx bx-save"></i></span><span
                                        class="button__text2">Salvar Alterações</span></button>
                                <a href="<?php echo base_url() ?>index.php/clientes" id=""
