  ...
  <div id="content-header">
   <div></div>
    ...
    <div class="container-flu">
      <div class="row-fluid">
        <div class="span12">
          <?php if ($var = $this->session->flashdata('success')): ?><script>Swal.fire("Sucesso!", "<?php echo str_replace('"', '', $var); ?>", "success");</script><?php endif; ?>
          <?php if ($var = $this->session->flashdata('error')): ?><script>Swal.fire({title: "Falha!", text: "<?php echo str_replace('"', '', $var); ?>", type: "error", confirmButtonText: "OK"});</script><?php endif; ?>
          <?php if (isset($view)) {
