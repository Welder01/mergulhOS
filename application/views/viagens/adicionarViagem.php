                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span12">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="data_partida" type="text" name="data_partida" value="<?= set_value('data_partida'); ?>" class="datetimepicker" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="data_retorno" class="control-label">Data e Hora do Retorno</label>
                            <div class="controls">
                                <input id="data_retorno" type="text" name="data_retorno" value="<?= set_value('data_retorno'); ?>" class="datetimepicker" />
                            </div>
                        </div>
                        <div class="control-group">
