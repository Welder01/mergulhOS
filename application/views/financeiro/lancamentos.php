        ...
        <div class="" style="display:flex">
            <a href="#modalReceita" data-toggle="modal" role="button" class="button btn btn-mini btn-success"
                ...
                <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2"
                    title="Cadastrar nova receita ou despesa"> Receita/Despesa</span></a>
        </div>
    <?php } ?>
        ...
        <form action="<?php echo current_url(); ?>" method="get">
            <div class="span12" style="margin-left: 0">
                <div class="span3">
                    ...
                    <select id="periodo" name="periodo" class="span12">
                        ...
                        <option value="mesAnterior" <?= $this->input->get('periodo') === 'mesAnterior' ? 'selected' : '' ?>>Mês
                            Anterior</option>
                        <option value="mes" <?= $this->input->get('periodo') === 'mes' ? 'selected' : '' ?>>Mês</option>
                        <option value="mesPosterior" <?= $this->input->get('periodo') === 'mesPosterior' ? 'selected' : '' ?>>
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4">
                    ...
                    <input id="cliente_busca" type="text" class="span12" name="cliente"
                        value="<?= $this->input->get('cliente') ?>">
                </div>

                <div class="span4">
                    <label>Usuário (Instrutor)</label>
                    <input id="usuario_busca" type="text" class="span12" name="usuario"
                        value="<?= $this->input->get('usuario') ?>">
                </div>

                <div class="span2">
                    <button type="submit" class="button btn btn-primary btn-sm" style="min-width: 120px">
                        <span class="button__icon"><i class='bx bx-filter-alt'></i></span><span
                            class="button__text2">Filtrar</span></a></button>
                </div>
            </div>
        </form>
    </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding tab-content">
              ...
              <td colspan="9" >Nenhum lançamento encontrado</td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6" style="text-align: right; color: green"><strong>Total Receitas:</strong>
                            </td>
                        ...
                        <tr>
                            <td colspan="7" style="text-align: left;"><strong>Estatísticas Gerais do
                        ...
                        <tr>
                            <td colspan="7" style="text-align: left;"><strong>Total Receitas (-) Despesas = Saldo
                                    Líquido: R$ <?php $sub_receita_despesa = $estatisticas_financeiro->total_receita - $estatisticas_financeiro->total_despesa;
                        ...
                        <tr>
                            <td colspan="7" style="text-align: left;">Total Receitas Pendentes: R$
                                <?php echo number_format($estatisticas_financeiro->total_receita_pendente, 2, ',', '.'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total Despesas Pendentes: R$
                                <?php echo number_format($estatisticas_financeiro->total_despesa_pendente, 2, ',', '.'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total de Receitas Pendentes (-) Despesas
                                Pendentes: R$ <?php $sub_recpendente_despependente = $estatisticas_financeiro->total_receita_pendente - $estatisticas_financeiro->total_despesa_pendente;
                                echo number_format($sub_recpendente_despependente, 2, ',', '.') ?></td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;"><strong>Total de Receitas Pendentes (+) Despesas
                                    Pendentes: R$ <?php $sub_recpendente_despependente = $estatisticas_financeiro->total_receita_pendente + $estatisticas_financeiro->total_despesa_pendente;
                                    echo number_format($sub_recpendente_despependente, 2, ',', '.') ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total de Descontos aplicados á lançamentos Pagos:
                                R$
                                <?php echo number_format($estatisticas_financeiro->total_valor_desconto, 2, ',', '.'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total de Descontos aplicados á lançamentos
                                Pendentes: R$
                                <?php echo number_format($estatisticas_financeiro->total_valor_desconto_pendente, 2, ',', '.'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;"><strong>Total de descontos aplicados (pagos +
                                    pendentes): R$ <?php $soma_descontos_pagos = $estatisticas_financeiro->total_valor_desconto + $estatisticas_financeiro->total_valor_desconto_pendente;
                                    echo number_format($soma_descontos_pagos, 2, ',', '.') ?></strong></td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total de Receitas sem descontos aplicados (pagos +
                                pendentes): R$
                                <?php echo number_format($estatisticas_financeiro->total_receita_sem_desconto, 2, ',', '.'); ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="7" style="text-align: left;">Total de Despesas sem descontos aplicados (pagos +
                                pendentes): R$
                                <?php echo number_format($estatisticas_financeiro->total_despesa_sem_desconto, 2, ',', '.'); ?>
                            </td>
                        </tr>
                    </tfoot>
                </table>
    ...
    <form id="formReceita" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita" method="post">
        ...
        <div class="modal-body">
            ...
            <div class="span12" style="margin-left: 0">
                <div class="span12" style="margin-left: 0">
                    <div class="span12" style="margin-left: 0">
                        <label for="cliente">Beneficiário*</label>
                        <div class="control-group">
                            <label class="radio inline" style="padding-top:0"><input type="radio" name="tipo_pessoa"
                                    value="cliente" checked
                                    onchange="togglePessoa('cliente', '#cliente', '#idCliente')"> Cliente/Fornecedor
                            </label>
                            <label class="radio inline" style="padding-top:0"><input type="radio" name="tipo_pessoa"
                                    value="usuario" onchange="togglePessoa('usuario', '#cliente', '#idCliente')">
                                Usuário (Instrutor) </label>
                        </div>
                ...
                <div class="span12" style="margin-left: 0">
                    <div class="span4" style="margin-left: 0">
                        ...
                        <input class="span12 money" id="valor" type="text" name="valor" data-affixes-stay="true"
                            data-thousands="" data-decimal="." required />
                    </div>

                    <div class="span4">
                        <label for="descontos">Desconto</label>
                        <input class="span6 money" id="descontos" type="text" name="descontos" value=""
                            placeholder="em R$" style="float: left;" />
                        <input class="btn btn-inverse" onclick="mostrarValores();" type="button" name="valor_desconto"
                            value="Aplicar" placeholder="R$" style="margin-left:3px; width: 70px;" />
                    </div>

                    <div class="span3">
                        <label for="valor_desconto">Val.Desc <i class="icon-info-sign tip-left"
                                title="Não altere esta campo, caso clicar nele e sair e ficar vázio, terá que recarregar á pagina e inserir de novo"></i></label>
                        <input class="span12 money" id="valor_desconto" readOnly="true" title="Não altere este campo"
                            type="text" name="valor_desconto"
                            value="<?php echo number_format("0.00", 2, ',', '.') ?>" />
                    </div>

                    <div class="span4" style="margin-left: 0">
                        <label for="vencimento">Data Vencimento*</label>
                        <input class="span12 datepicker" autocomplete="off" id="vencimento" type="text"
                    ...
                    <div class="span5">
                        ...
                        <a href="#modalReceitaParcelada" id="abrirmodalreceitaparcelada" data-toggle="modal"
            ...
            <div class="modal-footer" style="display:flex;justify-content: right">
                ...
                <button class="button btn btn-primary" style="min-width: 110px">
                    <span class="button__icon"><i class='bx bx-save'></i></span><span class="button__text2">Adicionar
...
<div id="modalReceitaParcelada" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <form id="formReceita_parc" action="<?php echo base_url() ?>index.php/financeiro/adicionarReceita_parc"
        method="post">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        ...
        <div class="modal-body">
            ...
            <div class="span6" style="margin-left: 0">
                <label for="cliente_parc">Beneficiário*</label>
                <div class="control-group">
                    <label class="radio inline" style="padding-top:0"><input type="radio" name="tipo_pessoa_parc"
                            value="cliente" checked
                            onchange="togglePessoa('cliente', '#cliente_parc', '#idCliente_parc')"> Cliente/Fornecedor
                    </label>
                    <label class="radio inline" style="padding-top:0"><input type="radio" name="tipo_pessoa_parc"
                            value="usuario" onchange="togglePessoa('usuario', '#cliente_parc', '#idCliente_parc')">
                        Usuário (Instrutor) </label>
                </div>
            ...
            <div class="span12" style="margin-left: 0">
                ...
                <div class="span4" style="margin-left: 2">
                    ...
                    <input class="span6 money" id="descontos_parc" type="text" name="descontos_parc" value=""
                        placeholder="em R$" style="float: left;" />
                    <input class="btn btn-inverse" onclick="mostrarValoresParc();" type="button" name="desconto_parc"
                        value="Aplicar" placeholder="R$" style="width: 70px; margin-left:3px;" />
                </div>

                <div class="span3" style="margin-left: 0">
                    <label for="desconto_parc">Desconto <i class="icon-info-sign tip-left"
                            title="Não altere esta campo, caso clicar nele e sair e ficar vázio, terá que recarregar á pagina e inserir de novo"></i></label>
                    <input class="span6 money" id="desconto_parc" readOnly="true" title="Não altere este campo"
                        type="text" name="desconto_parc" value="<?php echo number_format("0.00", 2, ',', '.') ?>"
                        style="float: left;" />
                </div>
            ...
            <div class="span12" style="margin-left: 0;">
                <div class="span4">
                    <label for="entrada">Entrada <i class="icon-info-sign tip-right"
                            title="O valor da entrada será lançado como pago no dia atual (Hoje)"></i></label>
                ...
                <div class="span4" style="margin-left: 1">
                    ...
                    <input class="span12 datepicker" id="dia_pgto" type="text" name="dia_pgto"
                        value="<?php echo date('d/m/Y'); ?>" autocomplete="off" required />
                </div>

                <div class="span4" style="margin-left: 1">
                    <label for="dia_base_pgto">Data Base de Pgto* <i class="icon-info-sign tip-left"
                            title="Dia do mês que serão lançadas as parcelas restantes, iniciando-se pela data selecionada."></i></label>
                    <input class="span12 datepicker" id="dia_base_pgto" type="text" autocomplete="off"
                        name="dia_base_pgto" required />
                </div>
        ...
        <div class="modal-footer" style="display:flex;justify-content: center">
            ...
            <button class="button btn btn-success" id="submitReceita"><span class="button__icon"><i
                        class='bx bx-plus-circle'></i></span><span class="button__text2">Adicionar
                    Registro</span></button>
        </div>
    </form>
</div>
    ...
    <form id="formEditar" action="<?php echo base_url() ?>index.php/financeiro/editar" method="post">
        ...
        <div class="modal-footer" style="display:flex;justify-content: center">
            ...
            <div class="controls span4">
                <input disabled id="usuarioEditar" value=""
                    style="background-color: #f5f5f5; border-color: transparent; height: 10px">
            </div>
            <button class="button btn btn-warning" data-dismiss="modal" aria-hidden="true" id="btnCancelarEditar"
...
<div id="modalExcluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-footer" style="display:flex;justify-content:center;">
        <button class="button btn btn-warning" data-dismiss="modal" aria-hidden="true" id="btnCancelExcluir"><span
                class="button__icon"><i class="bx bx-x"></i></span><span class="button__text2">Cancelar</span></button>
        <button class="button btn btn-danger" id="btnExcluir"><span class="button__icon"><i
                    class='bx bx-trash'></i></span> <span class="button__text2">Excluir</span></button>
    </div>
</div>
