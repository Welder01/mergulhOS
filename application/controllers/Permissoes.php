    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $permissoes = [
                ...
                'aAlunoCurso' => $this->input->post('aAlunoCurso'),
                'dAlunoCurso' => $this->input->post('dAlunoCurso'),
                'aInstrutorCurso' => $this->input->post('aInstrutorCurso'),
                'dInstrutorCurso' => $this->input->post('dInstrutorCurso'),
                'aModuloCurso' => $this->input->post('aModuloCurso'),
                'dModuloCurso' => $this->input->post('dModuloCurso'),
                'aInstrutorModulo' => $this->input->post('aInstrutorModulo'),
                'dInstrutorModulo' => $this->input->post('dInstrutorModulo'),
                'eConclusaoModulo' => $this->input->post('eConclusaoModulo'),
                'aRequisitoCurso' => $this->input->post('aRequisitoCurso'),
                'dRequisitoCurso' => $this->input->post('dRequisitoCurso'),

                'aViagem' => $this->input->post('aViagem'),
                'eViagem' => $this->input->post('eViagem'),
                'dViagem' => $this->input->post('dViagem'),
                'vViagem' => $this->input->post('vViagem'),

                'vClienteViagem' => $this->input->post('vClienteViagem'),
                'aClienteViagem' => $this->input->post('aClienteViagem'),
                'eClienteViagem' => $this->input->post('eClienteViagem'),
                'dClienteViagem' => $this->input->post('dClienteViagem'),
                'aInstrutorViagem' => $this->input->post('aInstrutorViagem'),
                'dInstrutorViagem' => $this->input->post('dInstrutorViagem'),
                'vFichaOperacao' => $this->input->post('vFichaOperacao'),
                'vFichaViagem' => $this->input->post('vFichaViagem'),
                'aCustoViagem' => $this->input->post('aCustoViagem'),
                'dCustoViagem' => $this->input->post('dCustoViagem'),
                ...
                'cIntegracao' => $this->input->post('cIntegracao'),
                ...
                'imprimirBilhete' => $this->input->post('imprimirBilhete'),
                'cancelarBilhete' => $this->input->post('cancelarBilhete'),
                'vExpedicao' => $this->input->post('vExpedicao'),
                'aExpedicao' => $this->input->post('aExpedicao'),
                'eExpedicao' => $this->input->post('eExpedicao'),
                'dExpedicao' => $this->input->post('dExpedicao'),

                'vTransporte' => $this->input->post('vTransporte'),
                'aTransporte' => $this->input->post('aTransporte'),
                'eTransporte' => $this->input->post('eTransporte'),
                'dTransporte' => $this->input->post('dTransporte'),
            ];
